...
for basesize in [8,8,16,32,64,128]

      @info "Running Simulation with kxbatch_basesize=$basesize"
      
      results,time,rest... = @timed run_simulation!(sim;
            kyparallel=true,
            threaded=true,
            kxbatch_basesize=basesize,
            maxparallel_ky=64)
