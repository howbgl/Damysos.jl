...
const missing_coords = [
	(0.5623413251903491, 0.1333521432163324),
	(1.0, 0.1333521432163324),
	(0.7498942093324559, 0.1333521432163324),
	(0.4216965034285822, 0.1333521432163324)]


const id 		= parse(Int, ENV["SLURM_ARRAY_TASK_ID"])
const test 		= maketest(missing_coords[id]...,dt_sitp) 

global_logger(make_teelogger(
	joinpath(ENV["WORK"],"quadratic/zeta-M-sweep1/17x17_dt_1e-4"),
	"missing_slurmid="*ENV["SLURM_ARRAY_TASK_ID"]*"zeta=$(missing_coords[id][1])_M=$(missing_coords[id][2])"))
