...
const ens = parametersweep(sim,sim.numericalparams,:dky,LinRange(10.0,1.0,16))
...
const results,time,rest... = @timed run_simulation!(ens;kxparallel=true,kx_workers=16)
