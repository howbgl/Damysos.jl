...
path(ζ) = joinpath(ENV["WORK"], "zeta-M-sweep/1d/kxmax1/zeta=$(ζ)")
altpath(ζ) = joinpath(ENV["HPCVAULT"], "zeta-M-sweep/1d/kxmax1/zeta=$(ζ)")
...
const logger = make_teelogger(
	joinpath(ENV["WORK"], "zeta-M-sweep/1d/kxmax1"),
