...
function makesim( M = 0.5, ζ = 4.0, dt = 0.1, dkx = 1.0, dky = 1.0, kxmax = 100,
	datapath = "~/data", 
	plotpath = datapath)
...
const subdir    = "zeta-M-sweep1/3x3_kymax_coarsegrid_1e-2"
...
global_logger(make_teelogger(
	...
	"slurmid="*ENV["SLURM_ARRAY_TASK_ID"]*"zeta=$(pars_row.zeta)_M=$(pars_row.M)"))
