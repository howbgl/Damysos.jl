...
const dpath   = "/home/how09898/phd/data/hhgjl/zeta-sweep-2/dirac2d_5THz_20meV_800fs/long_t2/"*name
const ppath   = "/home/how09898/phd/plots/hhgjl/zeta-sweep-2/dirac2d_5THz_20meV_800fslong_t2/"*name

const sim     = Simulation(h,df,pars,obs,us,2,id,dpath,ppath)
const ens     = parametersweep(sim,sim.numericalparams,:dt,LinRange(0.01,0.005,6))
